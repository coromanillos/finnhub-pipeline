...
class LobbyingActivity(BaseModel):
    ...
    documentUrl:        str
    expenses:           Optional[int] = None   # null in 2589/3012 — use income OR expenses (mutually exclusive)
    houseRegistrantId:  Optional[str] = None   # null in 174/3012
    income:             Optional[int] = None   # null in 423/3012 — use income OR expenses (mutally exclusive)
    name:               str
    ...
    @field_validator("clientId", "registrantId", "senateId")
    @classmethod
